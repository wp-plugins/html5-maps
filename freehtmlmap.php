...
function free_map_plugin_menu() {
    ...
    add_menu_page(__('HTML5 Map Settings','html5-maps'), __('HTML5 Map Settings','html5-maps'), 'manage_options', 'free-map-plugin-main', 'free_map_plugin_maps' );
...
?>
    ...
    <span class="title"><?php _e('Map:', 'html5-maps') ?> </span>
...
<?php
    ...
    echo '<p>'.sprintf(__('Use shortcode %s for install this map', 'html5-maps'), '<b>[freehtml5map id="'.$map_id.'"]</b>').'</p>';
